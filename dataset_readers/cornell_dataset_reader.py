...
class CornellDatasetReader(DatasetReader):
    ...
    def _get_dialog_lines(self, dataset_dir):
        """
        This method is used to retrieve all the dialog lines from the dataset.
        """
    ...
    def get_conversations(self, dataset_dir):
        """
        This method is used to retrieve all conversations from the dataset directory.
        """
